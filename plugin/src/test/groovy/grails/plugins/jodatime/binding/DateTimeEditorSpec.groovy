...
class DateTimeEditorSpec extends Specification implements GrailsUnitTest {
    ...
    void "getAsText formats #type.simpleName instances correctly for #locale locale"() {
        ...
        LocalDate     | new LocalDate(1971, 11, 29)           | UK     | "29/11/1971"
        LocalDate     | new LocalDate(1971, 11, 29)           | US     | "11/29/71"
        LocalDateTime | new LocalDateTime(2009, 3, 6, 17, 0)  | UK     | "06/03/2009, 17:00"
        LocalDateTime | new LocalDateTime(2009, 3, 6, 17, 0)  | US     | "3/6/09, 5:00 PM"
        DateTime      | new DateTime(2009, 3, 6, 17, 0, 0, 0) | UK     | "06/03/2009, 17:00"
        ...
        Instant       | new Instant(92554380000)              | UK     | "07/12/1972, 05:33"
    ...
    def "Instant values are always formatted as UTC"() {
        ...
        when:
        editor.value = new Instant(92554380000)
        then:
    ...
    void "setAsText parses #type.simpleName instances from #locale locale format text"() {
        ...
        LocalDate     | "29/11/1971"        | UK     | new LocalDate(1971, 11, 29)
        LocalDate     | "11/29/71"          | US     | new LocalDate(1971, 11, 29)
        LocalDateTime | "06/03/2009, 17:00" | UK     | new LocalDateTime(2009, 3, 6, 17, 0)
        LocalDateTime | "3/6/09, 5:00 PM"   | US     | new LocalDateTime(2009, 3, 6, 17, 0)
        DateTime      | "06/03/2009, 17:00" | UK     | new DateTime(2009, 3, 6, 17, 0, 0, 0)
        ...
        Instant       | "07/12/1972, 05:33" | UK     | new DateTime(1972, 12, 7, 5, 33, 0, 0).toInstant()
